...
// import { ADMIN_LINK, BASE_LINKS, CLASSROOM_LINK, PROFILE_LINK, SIGNIN_LINK } from "./typesAndData";
...
//   //don't do anything for thi useEffect
//   useEffect(() => {
//     let ticking = false;
//     const handleScroll = () => {
...
export default function Navbar() {
  ...
  const navLinks = useMemo(() => {
    ...
    // remove callback link for menu display
    return links.filter((link) => link.href !== "/request-callback");
  }, [user]);
